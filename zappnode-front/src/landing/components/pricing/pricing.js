...
const Pricing = () => {
    ...
    return(
        <section id="pricing" className="pricing bg-primary text-primary flex flex-col py-10 pb-32 ">
        <h1 className="text-4xl font-extrabold text-center mt-16">A pricing option for every need.</h1>
        ...
        <p className="text-center font-semibold">Or simply <a href="/register" className="transition duration-500 text-green-500 hover:text-green-300">create an account</a> and start your FREE trial.</p>
        </section>
    )
}
