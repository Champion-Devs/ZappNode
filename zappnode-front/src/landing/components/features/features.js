...
const Features = () => {
    return(
        ...
        <Card heading="Port Monitoring" content="Find out if your server is still running on the same port."/>
        <Card heading="Limitless Testing" content="Monitor HTTP(s), Ping, Ports, Keywords and APIs as much as you need."/>
        <Card heading="Quick Alerts" content="A wide range of fast notification options to integrate into your workflow."/>
