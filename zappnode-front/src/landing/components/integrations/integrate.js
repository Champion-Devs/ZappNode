...
let Integrate = ()=> {
    ...
    // need refactoring
    return(
        <section id="integration" className="integrations flex justify-center flex-col bg-primary py-16">
        <h1 className="font-bold text-4xl text-center color-secondary">
            Blazingly <span className="text-green-500">fast</span> notifications.
        </h1>
        <p className="text-center w-2/3 mt-3 mx-auto  font-base font-semibold color-secondary">
        ...
        <p className="text-center w-2/3 mt-5 mx-auto color-secondary">
