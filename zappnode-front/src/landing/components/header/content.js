...
const ContentR = ()=> {
    return (
        <div className="lg:block md:hidden sm:hidden mb-10 lg: mx-0 md: mx-auto sm: mx-auto w-1/2 mt-5">
...
const ContentL = ()=> {
    return (
        <div className="container w-1/2 sm:w-auto md:w-full lg:w-32 xl:w-3/4  mt-16 px-5 lg:mr-10 md:mr-0 lg:text-left md:text-center lg:ml-10 md:ml-0 sm:pb-10 lg:pb-0 md:pb-10">
