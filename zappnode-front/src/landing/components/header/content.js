...
const ContentL = ()=> {
    ...
    return (
        <div data-aos="fade-right" className="animate__backInDown mt-b container sm:w-auto center-text w-full mt-16 px-5 lg:mr-10 md:mr-0 lg:text-left md:text-center lg:ml-10 md:ml-0 sm:pb-10 lg:pb-0 md:pb-10">
...
const Content = ()=> {
    ...
    return(
        <div className="container my-auto mt-b pb-16 flex text-primary pt-10 justify-center lg:mt-24 md:mt-24 lg:flex-row md: flex-col sm: flex-row sm:mx-auto">
        <ContentL/>
        <ContentR/>
        </div>
    )
